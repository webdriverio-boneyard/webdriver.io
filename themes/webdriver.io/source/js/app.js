var testimonials = [{
  ...
  name: '@tikohatico',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-170257894',
  ...
  text: 'Been using WebdriverIO since may of 2015 at <a href="http://www.thomascook.se">Thomas Cook Northern Europe</a>. ' +
        'The api is super well organized and easy to find stuff in. Can\'t endorse this enough!',
  name: 'Joar Ekendahl',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-170458518',
  ...
  name: '@pazone',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-170490373',
  url: 'https://github.com/pazone',
  avatar: 'https://avatars2.githubusercontent.com/u/3244018?v=3&s=460'
}, {
  text: 'WebdriverIO [...] has helped us with ease of good and faster execution in moving from traditional selenium ' +
        'webdriver. We at <a href="https://www.axway.com/en">Axway</a> are using it for our UI Automation Testing.',
  name: '@anarwal',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-170683577',
  url: 'https://github.com/anarwal',
  avatar: 'https://avatars3.githubusercontent.com/u/15256209?v=3&s=460'
}, {
  text: 'We\'re just starting to use Webdriverio at the <a href="http://ft.com/">Financial Times</a>, [...].' +
        'Webdriverio is a comprehensive, well documented project [...].',
  name: 'George Crawford',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-171286700',
  ...
  text: 'At <a href="https://wearestagetwo.com/">Stage Two</a> we use Webdriver.IO to automate as many of our tests ' +
        'as possible. The framework is great to work with, as is the support provided',
  name: 'Dave Houlker',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-171342734',
  ...
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-171414885',
  ...
  name: '@bonjonbovi87',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-171445041',
  ...
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-171798309',
  ...
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-174192890',
  ...
  text: '<a href="http://www.buildfocus.io/">Build Focus</a> uses WebdriverIO for all its system testing. It\'s ' +
        'fantastic to use [...] and lets you write genuinely readable tests with minimum mess.',
  name: 'Tim Perry',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-174575880',
  ...
  text: 'THIS IS SIMLY THE FUTURE OF TESTING. EASY, OUT THE BOX, MADE BY COMMITTED DEVELOPERS AND TESTING ' +
        'EVANGELISTS!!!! I am shouting this!',
  name: 'Sajjad Hossain',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-174793528',
  ...
  name: 'Pat Thiel',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-175241631',
  ...
  name: 'Josh Cypher',
  ref: 'https://github.com/webdriverio/webdriverio/issues/1000#issuecomment-178047591',
...
App.prototype.generateTestimonial = function () {
    ...
    var text = $('<div />').addClass('text').html(data.text + ' - by ').append(user);
    var testimonial = $('<div />').addClass('testimonial').append(link).append(text);
    return testimonial
}
